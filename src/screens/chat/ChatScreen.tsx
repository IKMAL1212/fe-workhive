...
const ChatScreen: React.FC<ChatScreenProps> = ({ navigation }) => {
  const chatData: ChatItem[] = [
    ...
    },
    {
      ...
      message: 'yeaah bro!',
      profileImage: require('../../../assets/chat/2.png'),
      unread: true,
    },
    {
      id: '3',
      name: 'Ikmal Simbolon',
      message: 'Cancel',
      profileImage: require('../../../assets/chat/3.png'),
      unread: false,
    },
    {
      id: '4',
      name: 'Azizi Nababan',
      message: 'Up',
      profileImage: require('../../../assets/chat/4.png'),
      unread: false,
    },
    {
      id: '5',
      ...
      profileImage: require('../../../assets/chat/5.png'),
      unread: false,
    },
    {
      id: '6',
      ...
      profileImage: require('../../../assets/chat/6.png'),
      unread: false,
    },
    {
      id: '7',
      name: 'Inola Limbong',
      message: 'I agree',
      profileImage: require('../../../assets/chat/7.png'),
      unread: false,
    },
  ];
